...
describe("pending", function () {
  ...
  describe("synchronous skip()", function () {
    describe("in spec", function () {
      it("should immediately skip the spec and run all others", function (done) {
        run("pending/skip-sync-spec.fixture.cjs", args, function (err, res) {
          if (err) {
            return done(err);
          }
    ...
    describe("in before", function () {
      ...
      it("should run before and after hooks", function (done) {
        run("pending/skip-sync-before-hooks.fixture.cjs", function (err, res) {
          if (err) {
            return done(err);
          }
          expect(res, "to have failed with error", "should throw this error")
      ...
      it("should skip all sync/async inner before/after hooks", function (done) {
        run("pending/skip-sync-before-inner.fixture.cjs", function (err, res) {
          if (err) {
            return done(err);
          }
          expect(res, "to have failed with error", "should throw this error")
    ...
    describe("in beforeEach", function () {
      it("should skip all suite specs", function (done) {
        var fixture = "pending/skip-sync-beforeEach.fixture.cjs";
  ...
  describe("asynchronous skip()", function () {
    describe("in spec", function () {
      it("should immediately skip the spec and run all others", function (done) {
        run("pending/skip-async-spec.fixture.cjs", args, function (err, res) {
          if (err) {
            return done(err);
          }
          expect(res, "to have failed with error", "should throw this error")
    ...
    describe("in before", function () {
      ...
      it("should run before and after hooks", function (done) {
        run("pending/skip-async-before-hooks.fixture.cjs", function (err, res) {
          if (err) {
            return done(err);
          }
          expect(res, "to have failed with error", "should throw this error")
    ...
    describe("in beforeEach", function () {
      it("should skip all suite specs", function (done) {
        var fixture = "pending/skip-async-beforeEach.fixture.cjs";
        run(fixture, args, function (err, res) {
          if (err) {
            return done(err);
          }
  ...
  describe("programmatic usage", function () {
    it("should skip the test by listening to test event", function (done) {
      var path = require.resolve("./fixtures/pending/programmatic.fixture.cjs");
