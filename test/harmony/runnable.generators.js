...
module.exports = function() {
  describe('when fn is a GeneratorFunction', function() {
    ...
    it('should fail with an error if thrown', function(done) {
    ...
    it('should fail with an error if thrown after a yield', function (done) {
      var expectedErr = new Error('GeneratorFunction test');
      var test = new Runnable('es6', function * () {
