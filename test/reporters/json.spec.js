  ...
  describe('with output specified', function () {
    ...
    it('should have 1 test failure', function (done) {
      ...
      runner.run(function (failureCount) {
        ...
        assert.equal(typeof fileContents.stats.duration, 'number');
        assert.equal(fileContents.stats.duration <= 10, true);
        assert.equal(typeof fileContents.tests[0].duration, 'number');
        assert.equal(fileContents.tests[0].duration <= 10, true);
        assert.equal(typeof fileContents.failures[0].duration, 'number');
