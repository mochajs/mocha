// Playwright global setup step that bundles test/browser-specific/setup.js for the browser.
// The interface specs ("bdd" / "tdd" / "qunit") and ESM specs are loaded directly in the page, but setup.js relies on CommonJS "require" to build the global expect, so it has to be bundled first.
...
/**
 * Bundles setup.js into a single browser-ready IIFE (Immediately Invoked Function Expression).
 *
