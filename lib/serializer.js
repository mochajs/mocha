...
class SerializableWorkerResult {
   ...
   * @param {number} [failures=0] - Failure count
   */
...
class SerializableEvent {
  ...
  /**
   * Used internally by {@link SerilizableEvent#serialize}.
   * @ignore
   * @param {[object, string][]} pairs - List of parent/key tuples to process; modified in-place
...
exports.deserialize = function deserialize(value) {
  return SerializableWorkerResult.isSerializedWorkerResult(value)
