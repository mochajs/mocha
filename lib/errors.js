...
function createMultipleDoneError(runnable, originalErr) {
  return createMultipleDoneErrorFactory(runnable)(originalErr);
}

function createMultipleDoneErrorFactory(runnable) {
  var title;
  try {
  ...
  var messagePrefix = format(
    'done() called multiple times in %s %s',
    runnable.type ? runnable.type : 'unknown runnable',
    title
  );
  if (runnable.file) {
    messagePrefix += format(' of file %s', runnable.file);
  }

  return function multipleDoneErrorFactory(originalErr) {
...
module.exports = {
  ...
  createMultipleDoneErrorFactory: createMultipleDoneErrorFactory,
