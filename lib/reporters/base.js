...
exports.showRelativePaths = false;
...
function Base(runner, options) {
  ...
  exports.showRelativePaths = this.options.reporterOption && this.options.reporterOption.showRelativePaths;
...
exports.testFilePath = function (testFile) {  
  if (exports.showRelativePaths) {
