...
Base.prototype.testFilePath = function (testFile) {
  const showAsRelative =
    this.options.reporterOptions && this.options.reporterOptions.showAsRelative;
  
  if (showAsRelative) {
    const configPath = findConfig();
    const relativeTestPath = path.relative(configPath, testFile);
