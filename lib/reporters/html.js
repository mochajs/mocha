...
function HTML (runner) {
  ...
  runner.on('pass', function (test) {
    ...
    var markup = '<li class="test pass %e"><h2>%e<span class="duration">%ems</span> ' +
      '<a href="%e" class="replay">' + playIcon + '</a></h2></li>';
 ...
 *
 * @param {string} s (will be escaped)
 * @param {string} prefix (will not be escaped, precedes s, defaults to empty string)
 * @param {string} suffix (will not be escaped, follows s, defaults to empty string)
 * @return {string} A new URL.
 */
function makeUrl (s, prefix, suffix) {
