...
function HTML(runner) {
  ...
  runner.on('test end', function(test){
    ...
    if ('passed' == test.state) {
      var startEl = fragment ('<div class="test pass %e"><h2>', test.speed);
      var duration = fragment('<span class="duration">%ems</span>', test.duration);
      var endEl = '</h2></div>';
      var el = startEl + test.title + duration + endEl;
