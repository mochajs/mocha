...
function HTML(runner) {
  ...
  runner.on('suite', function(suite){
    ...
    // suite
    var url = fragment('%s%s?grep=^%s', window.location.origin, window.location.pathname, suite.title);
    var el = fragment('<div class="suite"><h1><a href="%s">%s</a></h1></div>', url, suite.title);
