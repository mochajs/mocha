...
var statsTemplate = '<ul id="mocha-stats">'
  ...
  + '<li class="pending"><a href="javascript:void(0);">pending:</a> <em>0</em></li>'
...
function HTML(runner) {
  ...
  var pending = items[2].getElementsByTagName('em')[0];
  var pendingLink = items[2].getElementsByTagName('a')[0];
