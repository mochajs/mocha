 ...
 * to a structure suitable for reporting.
 *
 ...
 *
 * @param {Object} data CoverJS coverage hash ({range, cover} elements).
 * @return {Array} Array representation of CoverJS coverage hash.
 */
 ...
 * Add coverage point.
 *
 * @param {Array} points Array of points to add to.
 * @param {Number} index Index of point in the source code string.
 * @param {String} id Coverage ID.
 * @param {Boolean} from Is it starting point of coverage range?
 * @param {Number} cover Number of coverages (i.e. statement calls).
 * @return {Array} Same points array.
 */
