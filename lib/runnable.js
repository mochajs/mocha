...
/**
 * Return the short title. Provides an override point
 * for hooks to augment their own title with the title
 * of current test.
 *
 * @return {String}
 * @api public
...
Runnable.prototype.shortTitle = function(){
  return this.title;
};
...
Runnable.prototype.fullTitle = function(){
  return this.parent.fullTitle() + ' ' + this.shortTitle();
};
