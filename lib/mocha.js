...
var createStatsCollector =
  require("./stats-collector.mjs").createStatsCollector;
const {
...
exports.interfaces = { ...require("./interfaces/index.mjs") };
/**
 * @public
 * @memberof Mocha
 */
exports.reporters = builtinReporters;
exports.Runnable = require("./runnable.mjs").Runnable;
exports.Context = require("./context.mjs").Context;
/**
 *
 * @memberof Mocha
 */
...
exports.Suite = Suite;
exports.Hook = require("./hook.mjs").Hook;
exports.Test = require("./test.mjs").Test;
...
function Mocha(options = {}) {
  ...
  if (typeof options.fast !== "undefined") {
...
/**
 * Sets the fast threshold value.
 *
 * Tests finishing below this threshold (in milliseconds) are considered "fast"
 * and won't have their duration displayed. If not explicitly set, defaults to
 * half of the slow threshold.
 *
 * @public
 * @param {number} msecs - Fast threshold value.
 * @return {Mocha} this
 * @chainable
 * @example
 *
 * // Sets "fast" threshold to zero (always show duration)
 * mocha.fast(0);
 * @example
 *
 * // Sets "fast" threshold using string argument
 * mocha.fast('100ms');
 */
Mocha.prototype.fast = function (msecs) {
  this.suite.fast(msecs);
  return this;
};
