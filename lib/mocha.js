...
import * as esmUtils from "./nodejs/esm-utils.js";
 ...
 */
if (!utils.isBrowser() && typeof module !== "undefined" && typeof module.paths !== "undefined") {
  var cwd = utils.cwd();
  module.paths.push(cwd, path.join(cwd, "node_modules"));
}

Mocha.Context = Context;
Mocha.Hook = Hook;
Mocha.interfaces = interfaces;
Mocha.reporters = reporters;
Mocha.Runnable = Runnable;
Mocha.Runner = Runner;
Mocha.Suite = Suite;
Mocha.Test = Test;
Mocha.utils = utils;
...
Mocha.prototype.run = function (fn) {
  ...
  if (options.color !== undefined) {
    reporters.Base.useColors = options.color;
  }
  reporters.Base.inlineDiffs = options.inlineDiffs;
  reporters.Base.hideDiff = !options.diff;
...
Mocha.prototype.parallelMode = function parallelMode(enable = true) {
  ...
  this._runnerClass = parallel
    ? require("./nodejs/parallel-buffered-runner.js")
    : Runner;
