 ...
 * @public
 * @see [Mocha.cleanReferencesAfterRun](/#cleanReferencesAfterRun)
 * @default true
...
Mocha.prototype.run = function(fn) {
  ...
  this._runIsInProgress = true;
  if (this._isDisposed || this._referencesCleaned) {
  ...
  var runner = new exports.Runner(suite, options.delay, this._autoDispose);
  ...
  function done(failures) {
    ...
    self._runIsInProgress = false;
    self._referencesCleaned = self._cleanReferencesAfterRun;
    fn = fn || utils.noop;
    if (reporter.done) {
