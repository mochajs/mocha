...
var InvalidReporterError = errors.InvalidReporterError;
...
Mocha.prototype.reporter = function(reporter, reporterOptions) {
  if (typeof reporter === 'function') {
    ...
    if (!_reporter) {
      throw new InvalidReporterError('invalid reporter "' + reporter + '"');
    }
...
Mocha.prototype.ui = function(name) {
  ...
  if (!this._ui) {
    try {
      ...
      throw new InvalidInterfaceError('invalid interface "' + name + '"');
    }
  }
