 ...
 * @param {MochaRootHooks} [options.rootHooks] - Hooks to bootstrap the root
 * suite with
 */
...
Mocha.prototype.run = function(fn) {
  if (this.files.length && !this.lazyLoadFiles) {
    this.loadFiles();
  }
  var suite = this.suite;
 ...
 * @param {MochaRootHooks} [hooks] - Hooks to assign to root suite
 * @chainable
 */
