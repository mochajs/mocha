 ...
 * <br>
 * The regexp is tested against the full title of each test<br>
 * (i.e., the name of the test preceded by titles of each its ancestral suites).
 * <br>As such, using an <em>exact-match</em> fixed pattern against the
 * test name itself<br>will not yield any matches.
 * <br>
...
/**
 * Enable or disable ignoring global leaks.
 *
 * @public
