...
class Suite extends EventEmitter {
  ...
  clone() {
    ...
    suite._allowUncaught = this._allowUncaught;
    return suite;
  }
  ...
  /**
   * Enable or disable allowUncaught for this suite and propagate the value to existing children. Called with no arguments inside a describe body
   * to opt the suite, and all of its tests/hooks, into letting uncaught exceptions bubble out of Mocha, pass false to opt out and override a parent suite or runner level setting.
   * @public
  ...
  allowUncaught(value) {
    this._allowUncaught = arguments.length === 0 ? true : Boolean(value);
    for (const t of this.tests) {
      if (t._allowUncaught === undefined) {
        t._allowUncaught = this._allowUncaught;
      }
    }
    for (const s of this.suites) {
      if (s._allowUncaught === undefined) {
        s._allowUncaught = this._allowUncaught;
      }
    }
    for (const hooks of [
      this._beforeAll,
      ...
      for (const h of hooks) {
        if (h._allowUncaught === undefined) {
          h._allowUncaught = this._allowUncaught;
        }
      }
    }
    return this;
  ...
  _createHook(title, fn) {
    ...
    hook.slow(this.slow());
    if (this._allowUncaught !== undefined) {
      hook._allowUncaught = this._allowUncaught;
    }
    hook.ctx = this.ctx;
    hook.file = this.file;
    return hook;
  ...
  addSuite(suite) {
    ...
    if (
      this._allowUncaught !== undefined &&
      suite._allowUncaught === undefined
    ) {
      suite._allowUncaught = this._allowUncaught;
    }
  ...
  addTest(test) {
    ...
    if (
      this._allowUncaught !== undefined &&
      test._allowUncaught === undefined
    ) {
      test._allowUncaught = this._allowUncaught;
    }
    test.ctx = this.ctx;
