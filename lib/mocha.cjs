...
exports.xcontext = exports.describe.skip;
...
exports.specify = exports.it;
exports.xit = exports.it.skip;
exports.xspecify = exports.it.skip;
...
Mocha.prototype.ui = function (ui) {
  ...
  this._uiUsesGlobalContext = bindInterface.requiresGlobalContext !== false;
...
Mocha.prototype._createPreRequireContext = function () {
  return this._uiUsesGlobalContext === false ? {} : global;
};
...
Mocha.prototype.loadFiles = function (fn) {
  ...
  this.files.forEach(function (file) {
    ...
    var context = self._createPreRequireContext();
    suite.emit(EVENT_FILE_PRE_REQUIRE, context, file, self);
    suite.emit(EVENT_FILE_REQUIRE, require(file), file, self);
    suite.emit(EVENT_FILE_POST_REQUIRE, context, file, self);
  });
  fn && fn();
};
...
Mocha.prototype.loadFilesAsync = function ({ esmDecorator } = {}) {
  ...
  return esmUtils.loadFilesAsync(
    ...
    function (file, resultModule, context) {
      file = path.resolve(file);
      context = context || self._createPreRequireContext();
