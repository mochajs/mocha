...
Runner.prototype.runSuite = function(suite, fn) {
  ...
  var notSkippedTestCount = calculateNotSkippedTests(suite);
  var runAtLeast1Test = notSkippedTestCount > 0;
...
function calculateNotSkippedTests(suite) {
  var tests = suite.tests;
  var currentTestsCount = tests.filter(function(test) {
    return !test.isPending();
  }).length;
  var total = currentTestsCount;
