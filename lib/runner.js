...
/**
 * wrapper for setTimeout saved to avoid Sinon interfering.
 * @param {Function} fn
 * @param {number} ms
 * @private
 */
Runner.setTimeout = global.setTimeout;
      ...
      self.runTest(function (err) {
        ...
        if (test.pending) {
          ...
          if (retry < test.retries()) {
            ...
            var retryDelay = test.retryDelay();
            return self.hookUp(HOOK_TYPE_AFTER_EACH, function (hookErr) {
              if (retryDelay > 0 && !self._abort) {
