...
class Runner extends EventEmitter {
   ...
   * @param {string[]} [opts.initialGlobals] - Global properties to treat as pre-existing when checking for leaks; defaults to those present when the `Runner` is created.
   */
  constructor(suite, opts = {}) {
    ...
    this._initialGlobals = opts.initialGlobals || this.globalProps();
    this.globals(this._initialGlobals);
