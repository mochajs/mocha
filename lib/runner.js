 ...
 * @param {boolean} [cleanReferencesAfterRun] Whether to clean references to test fns and hooks when a suite is done.
 */
function Runner(suite, delay, cleanReferencesAfterRun) {
  var self = this;
  this._globals = [];
  this._abort = false;
  this._delay = delay;
  this.suite = suite;
  this.started = false;
  this._cleanReferencesAfterRun = cleanReferencesAfterRun;
  this.total = suite.total();
  this.failures = 0;
  /**
   * @types {[[EventEmitter, string, function]]}
   */
...
Runner.prototype.run = function(fn) {
  ...
  if (this._cleanReferencesAfterRun) {
