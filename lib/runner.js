...
Runner.prototype.initStatCollection = function () {  
...
Runner.prototype.run = function(fn){
  ...
  this.on('end', function(){
    ...
    fn(this.stats, this.tests.all, this.tests.passes, this.tests.pending, this.tests.failures);
  });
