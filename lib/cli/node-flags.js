...
import { isMochaFlag } from "./run-option-metadata.js";
 ...
 * @private
 */
export const isNodeFlag = (flag, bareword = true) => {
  if (!bareword) {
 ...
 * @private
 */
export const impliesNoTimeouts = (flag) => debugFlags.has(flag);
 ...
 * @private
 */
export const unparseNodeFlags = (opts) => {
