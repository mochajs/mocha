...
const _loadRc = loadRc;
export { _loadRc as loadRc };
...
const _loadPkgRc = loadPkgRc;
export { _loadPkgRc as loadPkgRc };
...
export { _loadOptions as loadOptions };
const _YARGS_PARSER_CONFIG = YARGS_PARSER_CONFIG;
export { _YARGS_PARSER_CONFIG as YARGS_PARSER_CONFIG };
