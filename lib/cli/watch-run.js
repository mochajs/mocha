 ...
 * @param {import('./collect-files').FileCollectionOptions} fileCollectParams - Parameters that control test
 * @private
 */
 ...
 * @param {import('./collect-files').FileCollectionOptions} opts.fileCollectParams - List of extensions to watch if `opts.watchFiles` is not given.
 ...
 *
 * @param {Mocha} mocha - Mocha instance
 * @param {import('chokidar').FSWatcher} watcher - chokidar `FSWatcher` instance
 * @param {Object} [opts] - Options!
 ...
 * @param {import('chokidar').FSWatcher} watcher - chokidar FSWatcher
 * @ignore
 * @private
 */
 ...
 * @private
 * @param {{mocha: Mocha, watcher: import('chokidar').FSWatcher}} options
 * @returns {Mocha}
 */
 ...
 * @private
 * @property {() => void} run - Calls `mocha.run()`
 * @property {() => void} scheduleRun - Schedules another call to `run`
 */
