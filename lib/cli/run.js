...
const {createOneAndDoneConflicts, ONE_AND_DONES} = require('./one-and-dones');
...
// construct the same options for all variants on
// reporter option for backwards compatibility
const reporterOptionVariants = [
  'reporterOption',
  'reporterOptions',
  'reporter-option',
  'reporter-options'
...
exports.builder = yargs =>
  yargs
    .options({
      ...
      'list-interfaces': {
        conflicts: createOneAndDoneConflicts('list-interfaces'),
        description: 'List built-in user interfaces & exit'
      },
      'list-reporters': {
        conflicts: createOneAndDoneConflicts('list-reporters'),
