...
const {createUnsupportedError, createInvalidPluginError} = require('../errors');
 ...
 * @returns {Array<import('../mocha').MochaRootHookObject|import('../mocha').MochaRootHookFunction>} Any root hooks
 * @private
 */
 ...
 * @param {Array<import('../mocha').MochaRootHookObject|import('../mocha').MochaRootHookFunction>} rootHooks - Array of root hooks
 * @private
 * @returns {import('./mocha').MochaRootHookObject}
 */
