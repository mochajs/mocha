...
/** @see https://html.spec.whatwg.org/multipage/syntax.html#table-charref-overrides. */
const bmpWhitelistRegex = /[\x01-\t\x0B\f\x0E-\x1F\x7F\x81\x8D\x8F\x90\x9D\xA0-\uFFFF]/g;
...
exports.escape = function (html) {
  ...
  return html
    .replace(unsafeCharsRegex, escapeHex)
    .replace(surrogatePairRegex, escapeSurrogate)
    .replace(bmpWhitelistRegex, escapeHex);
};
