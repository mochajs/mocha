...
import isUnicodeSupportedCheck from "is-unicode-supported";

var isUnicodeSupported = isUnicodeSupportedCheck()
 ...
 * @return {string}
 */
export const escape = function (html) {
 ...
 */
export function canonicalize(value, stack, typeHint) {
 ...
 * @returns {Function}
 */
export function stackTraceFilter () {
 ...
 */
export function defineConstants (obj) {
 ...
 * @returns {*}
 */
export const breakCircularDeps = (inputObj) => {
  const seen = new Set();
