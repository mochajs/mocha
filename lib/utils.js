...
var NoFilesMatchPatternError = errors.NoFilesMatchPatternError;
var MissingArgumentError = errors.MissingArgumentError;
var UndefinedError = errors.UndefinedError;
...
exports.lookupFiles = function lookupFiles(filepath, extensions, recursive) {
  ...
  if (!fs.existsSync(filepath)) {
    if (fs.existsSync(filepath + '.js')) {
      ...
      if (!files.length) {
        throw new NoFilesMatchPatternError(
  ...
  fs.readdirSync(filepath).forEach(function(file) {
    ...
    if (!extensions) {
      throw new MissingArgumentError(
        'Parameter required when filepath is a directory',
        'extensions'
      );
    }
