...
- [CLI](/next/running/cli) for the commands you can pass to `mocha`
- [Configuring](/next/running/configuring) for creating a persistent test configuration file
- [Editor Plugins](/next/running/editor-plugins) for improving the Mocha experience in your editor
