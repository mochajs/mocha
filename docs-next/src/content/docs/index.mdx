...
:::tip[New Site Preview]
Hello!
Welcome to this preview of a revamped **mochajs.org** docs site!

This is a WIP preview that is not yet production-ready.
If you see any **bugs** or **typos** _that aren't on mochajs.org_, please mention them on [docs: add new website using Astro Starlight](https://github.com/mochajs/mocha/pull/5246).
Thanks!
:::
