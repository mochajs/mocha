...
<PackageManagers dev type="add" pkg="mocha @types/mocha" />
...
:::note
Node.js native type stripping requires Node.js v22.6.0 or later. For older Node versions or more complex setups, see the [mocha-examples TypeScript packages](https://github.com/mochajs/mocha-examples).
:::
...
<PackageManagers dev type="add" pkg="ts-node typescript" />
