...
#### AI-Generated Code by Maintainers

Maintainers may use AI tools (GitHub Copilot, Claude, etc.) to assist in their work.
However, when a maintainer uses AI to generate a non-trivial amount of code (approximately **10 or more lines**), that code **must be reviewed and approved by another maintainer** before merging.

This requirement ensures that:

- AI-generated code receives proper scrutiny for correctness, security, and adherence to project standards
- We maintain accountability and shared understanding of changes
- We avoid the risk of blindly accepting AI-generated code that may contain subtle bugs or vulnerabilities

This applies to code generated by a maintainer, not to PRs from external contributors (which already require maintainer review).
Trivial changes (such as documentation typos, minor formatting adjustments, or small refactorings under 10 lines) may be merged without additional review, per existing guidelines.
