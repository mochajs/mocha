...
const getSupporters = async () => {
  ...
  // TODO: This supporters.js script writes supporter data to files within the docs/ directory.
  // It's used both by scripts outside of docs/ and within the docs/ build process.
