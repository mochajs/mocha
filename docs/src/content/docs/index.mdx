...
[spies](/explainers/spies) and [shared behaviours](/explainers/shared-behaviours), have a look through our explainers.
For a running example of Mocha, view [example/tests.html](example/tests.html).

For the old docs website, see: [legacy.mochajs.org](https://legacy.mochajs.org).

For the JavaScript API, view the [API documentation](/api) or the [source](https://github.com/mochajs/mocha/blob/main/lib/mocha.cjs).
