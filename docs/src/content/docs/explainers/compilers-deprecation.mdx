---
description: Moving off the removed `--compilers` option.
title: Compilers deprecation
---

`--compilers` was removed in v6.0.0, and as of v12.0.0 Mocha doesn't error on it either: the value you pass gets picked up as a test file spec instead.
...
Then this is how you'd accomplish the same thing (`**` roughly means "recursive") in v4 and later:
