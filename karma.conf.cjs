...
const rollupPlugin = require("./scripts/karma-rollup-plugin.cjs");
...
const addStandardDependencies = (cfg) => ({
  ...
  files: [
    ...
    require.resolve("./test/browser-specific/setup.cjs"),
    ...cfg.files,
  ],
  rollup: {
    ...cfg.rollup,
  ...
  switch (value) {
    ...
    case "esm":
      return addStandardDependencies({
        ...
        files: [
          {
            pattern: "test/browser-specific/fixtures/esm.fixture.js",
            type: "module",
          },
          {
            pattern: "test/browser-specific/esm.spec.js",
            type: "module",
          },
        ],
      });
